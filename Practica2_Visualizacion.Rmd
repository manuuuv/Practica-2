...
grafico3 = ggplot(data=ds,aes(x=MinTemp,y=MaxTemp,col=RainTomorrow)) + ggtitle("Representaión de las temperaturas máximas y mínimas en función de si llueve mañana o no") + geom_point()
