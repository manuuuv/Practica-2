...
str(ds)
#Creamos el boxplot:
ggplot(data=ds,aes(x=Year,y=MinTemp))+ geom_boxplot(aes(col=RainToday))
#Creamos el gráfico de violines:
ggplot(data=ds,aes(x=Year,y=MaxTemp))+ geom_violin(aes(col=RainToday)) + ggtitle("Distribución de temperaturas máximas por año")
